...
SCRIPTS = {
    ...
    "iid":     "fedMedian_iid.py",
    "non_iid": "fedMedian_non_iid.py",
...
def main():
    ...
    ap.add_argument("--skip-central", action="store_true", help="Skip centralized baseline")
    ap.add_argument("--no-plot", action="store_true", help="Skip plotting step")
    ap.add_argument("--keep-going", action="store_true", help="Continue on failures")
    ap.add_argument("--python-path", default=sys.executable, help="Python to use")
    args = ap.parse_args()
