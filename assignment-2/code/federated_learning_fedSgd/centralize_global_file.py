...
from sklearn.metrics import accuracy_score  # (unused; kept for parity with plots)
...
def main():
    """Run centralized training and persist artifacts."""
    np.random.seed(SEED)
    ...
    # Save preprocessing artifacts + raw splits for FL
